...
\begin{ejercicio}
En el caso del producto punto, ¿cuál es la expresión de la norma de un vector? De acuerdo a esta expresión, dé una expresión, en términos de la norma, para la distancia euclidiana en $\mathbb{R}^n$. 
\end{ejercicio}
